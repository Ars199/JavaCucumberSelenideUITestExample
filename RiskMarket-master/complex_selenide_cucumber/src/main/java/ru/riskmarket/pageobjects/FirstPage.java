...
public class FirstPage extends AbstractPage
{
    ...
    @FindBy(xpath = "//button[@aria-label='Вход в систему']")//(xpath = "//button[.='Вход в кабинет']")
    public SelenideElement enterToCabinet;

    @NameOfElement("Логин")
    @FindBy(css = "input[type='email']")//(css = "input[name='userName']")
    ...
    @NameOfElement("Войти")
    @FindBy(xpath = "//button[contains(text(),'Войти')]")//(css = "input[value='Войти']")
