...
Feature: smoke test #1, go through the service to button "Купить"
  ...
  Scenario: go through the service to button "Купить"
    ...
    And type to input with name "Логин" text: "arsgrendal@yandex.ru" on "первая страница"
    And type to input with name "Пароль" text: "xwM24lz2u15zX6" on "первая страница"
