...
public class MyStepdefs
{
    ...
    {
        firstPage.get("Фрейм входа в кабинет");//.waitUntil(Condition.disappear, 7000);
    }
    ...
    public void waitUntilSpinnerDisappears()
    {
        ...
        secondPage.get("Spinner");//.waitUntil(Condition.disappear, 30000);
    }
    ...
    {
        firstPage.get(elementName).shouldBe(Condition.appear);
    }
}
