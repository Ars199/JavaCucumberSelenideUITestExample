...
public class MyStepdefs
{
    ...
    {
        $(byText(button)).click();//.waitUntil(Condition.visible, 15000).click();
    }
    ...
    {
        $(".modal-content");//.waitUntil(Condition.disappear, 7000);
    }
    ...
    {
        $(byValue(value)).click();//.waitUntil(Condition.enabled, 2000).click();
    }
